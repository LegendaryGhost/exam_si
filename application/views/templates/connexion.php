                                ...
                                <div class="col-lg-12 col-xl-12" style="padding-left: 228px;margin-left: -90px;">
                                    <div class="p-5" style="padding-left: 156px;background: var(--bs-tertiary-bg);">
                                        ...
                                        <form class="user" action="<?= base_url() ?>utilisateur/traitement_login" method="post">
                                            <div class="mb-3"><input required value="admin@gmail.com" class="form-control form-control-user" type="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Entree Addresse Email  ..." name="email"></div>
                                            <div class="mb-3"><input required value="admin" class="form-control form-control-user" type="password" id="exampleInputPassword" placeholder="Mot de passe" name="mot_de_passe"></div>
                                            <div class="mb-3">
